      ...
      <div className="flex gap-[50.07px]">
        ...
        {user?.uid ?
            <>
                ...
                <button className="text-white px-4 py-2 text-[14px] font-normal rounded-lg" style={{ backgroundColor: "rgba(52, 62, 255, 1)" }} onClick={handleLogout}>Sign Out</button>
            </>
            :
            <Link to="/signIn"><button className="text-white px-4 py-2 text-[14px] font-normal rounded-lg" style={{ backgroundColor: "rgba(52, 62, 255, 1)" }}>
            Sign in
          </button></Link>}
